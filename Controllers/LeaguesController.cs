...
namespace Lab1_IsTp__2.Controllers
{
    public class LeaguesController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            // return View(league);
            return RedirectToAction("Index", "Clubs", new { id = league.Id, name = league.Name, typeTournament = "Leagues" });
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ClubsNumber,Name")] League league)
        {
            if (id != league.Id)
            {
                return NotFound();
